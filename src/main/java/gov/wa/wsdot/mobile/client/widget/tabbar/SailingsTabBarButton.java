...
public class SailingsTabBarButton extends TabBarButton {

	public SailingsTabBarButton() {
		this(TabPanel.DEFAULT_APPEARANCE);
	}
	
	public SailingsTabBarButton(TabBarAppearance appearance) {
        super(appearance, LocalTabBarImageHolder.get().note());
