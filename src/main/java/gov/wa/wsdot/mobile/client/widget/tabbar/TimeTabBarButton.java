...
public class TimeTabBarButton extends TabBarButton {

	public TimeTabBarButton() {
		this(TabPanel.DEFAULT_APPEARANCE);
	}
	
	public TimeTabBarButton(TabBarAppearance appearance) {
        super(appearance, LocalTabBarImageHolder.get().time());
