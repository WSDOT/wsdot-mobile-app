...
public abstract class TravelTimesCell<T> implements Cell<T> {
	...
	public abstract String getDisplayTitle(T model);
	
	public abstract String getDisplayDistanceAverageTime(T model);
	
	public abstract String getDisplayLastUpdated(T model);
	
	public abstract String getDisplayCurrentTimeColor(T model);
	
	public abstract String getDisplayCurrentTime(T model);
