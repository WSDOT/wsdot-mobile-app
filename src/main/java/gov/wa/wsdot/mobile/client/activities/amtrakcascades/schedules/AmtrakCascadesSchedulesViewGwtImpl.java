...
public class AmtrakCascadesSchedulesViewGwtImpl extends Composite
		implements AmtrakCascadesSchedulesView {
	...
	public AmtrakCascadesSchedulesViewGwtImpl() {
		...
		cellList = new CellList<AmtrakCascadesServiceItem>(
				new AmtrakCascadesSchedulesCell<AmtrakCascadesServiceItem>() {
